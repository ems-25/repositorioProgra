...
//    
//    
//    public boolean isPremios(Premios premio)
//    {
//        for (int elemento = 0; elemento < premios.size(); elemento++)
//        {
//            if (personaje.getColumna()==premio.getColumna()&&personaje.getFila()==premio.getFila()) {
//                
//                premio.increasePremios();
...
//    public void ganará ()
//    {
//        if (isPremios(premio)==true)
//            
//            premio.floresRecolectadas();
//        {
//            
//        }
//    }
...
//            
//            
//            if (premios.getPremios()==4&&personaje.getFila()==21&&personaje.getColumna()==2) 
//            {
