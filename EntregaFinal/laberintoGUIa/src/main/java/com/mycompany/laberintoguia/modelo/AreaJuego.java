...
public class AreaJuego {
    ...
    public void dibujar(Graphics g) {
        personaje.show(g);//se muestra el personaje
        
        //un for para que recorra el arreglo de enemigos
        for (int elemento = 0; elemento < enemigos.size(); elemento++) 
        {
            //se muestran los enemigo
           enemigos.get(elemento).show(g);
         }
        // Dibujar los premios restantes
        //un for para que recorra el arreglo de premios
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    //                                                               metodo para moverEnemigo
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void moverEnemigo() 
    {
        for (Enemigo enemigo : enemigos)
        {
            //llamo al metodo mover que esta en la clase enemigo
            enemigo.mover(); 
            
            // llamo al metodo is vlido y le paso las coordenadas del enemigo y la condiciono junto con el laberinto
            if (isValido(enemigo.getFila(), enemigo.getColumna()) && laberinto.getCelda(enemigo.getFila(), enemigo.getColumna()) == 1)
            {
                ...
                //si se cumple el metodo isColision y por parametro el enemigo entra al if
                if (isColision(enemigo)) 
                {
                    //si colisiona el personaje pierde vidas en la clse personaje
                    personaje.perderVidas();
                    
                    //se pone un if para que si el personaje ya no tiene vidas la variable "perdio" se vuelve true
                    if (personaje.getVidas() == 0)
                    {
                        // la variable perdio se convierte en true
                        perdio = true;
                    }
                }
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
//                                                               fin del metodo caminar
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
  

    
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
//                                          metodo para verificar si el personaje chocó con un premio
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
//                                          metodo para mostrar un mensaje si el jugador perdió
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
  
    
     public boolean fin ()
     {
         //si la variable perdió es true entra
         if (perdio) 
         {
             //muestra el mensaje
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
//                                          metodos con condicionales para no ser repetitivos en otros metodos
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////    
